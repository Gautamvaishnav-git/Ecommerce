      ...
      <div className="flex bg-white border border-indigo-500/40 mb-6 sm:mx-2 rounded-md sm:flex-row flex-col py-2 px-3 items-center  gap-4">
        ...
        <div className="flex flex-col gap-2 grow w-full">
          ...
          <div className="flex gap-4 flex-wrap items-center">
            <Link
              to={`/product/${asin}`}
              className="bg-indigo-500 text-white w-fit px-3 py-2 rounded border border-transparent hover:border-indigo-500 hover:text-slate-900 hover:bg-transparent duration-150 sm:grow-0 grow"
            >
              View Product
            </Link>
